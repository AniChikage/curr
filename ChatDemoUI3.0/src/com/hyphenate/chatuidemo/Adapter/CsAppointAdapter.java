...
public class CsAppointAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            //获取list_item布局文件的视图
            convertView = listContainer.from(context).inflate(R.layout.csappointlistview, null);
            //获取控件对象
            listItemView.appoint_username = (TextView)convertView.findViewById(R.id.appoint_username);
        ...
        listItemView.appoint_username.setText((String) listItems.get(position).get("appoint_username"));
